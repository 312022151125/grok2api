  ...
  "zh-CN": {
    translation: {
      ...
      accounts: {
        ...
        updatedWithModelSyncFailure: "模型能力同步完成，但部分账号失败",
        ...
        exportCLIProxyDescription: "每个 Grok Build 账号导出为一个 xai-*.json（多个账号为 ZIP），可直接放入 CLIProxyAPI auth 目录。文件含 OAuth 密钥，请仅保存到可信位置。",
        exportWebAuth: "导出所有 Grok Web 账号",
