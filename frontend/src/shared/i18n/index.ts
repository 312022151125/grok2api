  ...
  "zh-CN": {
    translation: {
      ...
      accounts: {
        ...
        exportAuth: "导出账号文件",
        exported: "账号凭据已导出",
        exportCLIProxyAuth: "导出 CLIProxyAPI",
        exportCLIProxyDescription: "每个 Grok Build 账号导出一个 xai-*.json 文件（多个账号打包为 ZIP），可直接放入 CLIProxyAPI auth 目录。文件含 OAuth 密钥，请仅保存到可信位置。",
        exportCLIProxyOpen: "导出 CLIProxyAPI",
        exportCLIProxyTitle: "导出 CLIProxyAPI 凭据？",
        exportWebAuth: "导出全部 Grok Web 账号",
        exportWebDescription: "导出的 JSON 包含可直接登录 Grok Web 的 SSO 凭据和 Cloudflare Cookie。请仅保存到可信位置。",
        exportWebOpen: "导出 Grok Web",
        exportWebTitle: "导出全部 Grok Web 账号凭据？",
        exportedCLIProxy: "CLIProxyAPI 凭据已导出",
        exportedWeb: "Grok Web 账号凭据已导出",
  ...
  en: {
    translation: {
      ...
      apiErrors: {
        ...
        accountExportEmpty: "No accounts available to export",
...
Object.assign(resources["zh-CN"].translation.accounts as unknown as Record<string, string>, {
  ...
  unbindEgressDescription: "移除所选账号的固定代理绑定；账号随后按当前出口策略重新参与调度。",
...
Object.assign(resources.en.translation.accounts as unknown as Record<string, string>, {
  exportCLIProxyAuth: "Export CLIProxyAPI",
  exportCLIProxyDescription: "Each Grok Build account becomes one xai-*.json file (multiple accounts as a ZIP) for the CLIProxyAPI auth directory. Files contain OAuth secrets; store them only in a trusted location.",
  exportCLIProxyOpen: "Export CLIProxyAPI",
  exportCLIProxyTitle: "Export CLIProxyAPI credentials?",
  exportWebAuth: "Export all Grok Web accounts",
  exportWebDescription: "The exported JSON contains SSO credentials and Cloudflare cookies that can sign in to Grok Web. Store it only in a trusted location.",
  exportWebOpen: "Export Grok Web",
  exportWebTitle: "Export all Grok Web credentials?",
  exportedCLIProxy: "CLIProxyAPI credentials exported",
  exportedWeb: "Grok Web credentials exported",
  ...
  unbindEgressDescription: "Remove fixed proxy bindings from the selected accounts. They will return to the current egress routing policy.",
